...
1. Render your file into PDF by running the Knit command in RStudio (clicking the "Knit" button above the editor)

2. Upload your PDF file to Gradescope.

3. Remember to add your **group members** to the assignment submission.

4. Remember to mark the pages that correspond to each question!
